...
itog = (zero_ev * first_ev) * sp.sin(third_ev / (first_ev * second_ev * third_ev))

print("(", sp.expand((zero_ev * first_ev)), ")", sp.sin(third_ev / sp.expand((first_ev * second_ev * third_ev))))
