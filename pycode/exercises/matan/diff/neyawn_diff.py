...
def get_neyawn_diff(n_terms=3):
    ...
    res_latex = (equation_latex.replace(r"\operatorname", "").replace(r"atan", "arctg").replace(r"asin", "arcsin").replace(r"acos", "arccos")
                 .replace(r"\tan", "tg").replace("log", "ln").replace(r"\left(x \right)", ""))
    ans_latex = (answer_latex.replace(r"\operatorname", "").replace(r"atan", "arctg").replace(r"asin", "arcsin").replace(r"acos", "arccos")
