...
Подробная пользовательская и техническая документация английского модуля,
включая повторную генерацию WAV и диагностику микрофона: [docs/english_module.md](docs/english_module.md).
